...
export default function Component() {
  ...
  function handleRowClick(itemsId) {
    navigate(`/inventory/items/${itemsId}`);
  }

  const isAddItemPage =
    !itemId && window.location.pathname === "/inventory/items/add";
            ...
            <TableBody>
              {items.map((item) => (
                ...
                >
                  ...
                  <TableCell className="hidden sm:table-cell flex" >
                    {item.warehouse.map((ware) => (
                      <div key={ware} className="flex text-sm">
