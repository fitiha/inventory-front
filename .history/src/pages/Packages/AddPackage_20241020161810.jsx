              ...
              >
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {formData.packedDate ? format(formData.packedDate, "PPP") : <span>Pick a date</span>}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0 bg-white" align="start">
                  <Calendar
                    ...
                    onSelect={(date) => {
                      setFormData((prevData) => ({ ...prevData, packedDate: date }));
                ...
                <CardContent>
                  ...
                  {formData.items.map((item, index) => (
                    <div key={index} className="grid grid-cols-4 gap-4 items-center mb-4">
                      ...
                      <div className="grid gap-2">
                        <Input
                          value={item.orderedAmount}
                          readOnly
                        />
                      </div>
                      <div className="grid gap-2">
                        <Input
                          value={item.packedAmount}
                          readOnly
                        />
                      </div>
                      <div className="grid gap-2">
