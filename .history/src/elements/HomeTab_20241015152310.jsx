    ...
    <Tabs defaultValue="account" className="w-full">
      ...
      <TabsContent value="announcement" className="px-32">
        <Card>
          ...
          <CardContent className="flex justify-center p-32">
            <div>
                <img src="https://img.freepik.com/free-vector/illustrationn-megaphone-monochrome-style-isolated-white-background_1284-38767.jpg?t=st=1728994894~exp=1728998494~hmac=9a49fcd475fa09d206d506a86d790a623964a7ab1c6ab585d9e943a5d6d5a4b4&w=740" alt="announcement" />
