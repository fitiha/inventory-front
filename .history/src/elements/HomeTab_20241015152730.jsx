    ...
    <Tabs defaultValue="account" className="w-full">
      ...
      <TabsContent value="announcement" className="px-32">
        <Card>
          ...
          <CardContent className="flex justify-center pt-8 pb-16 px-32">
            <div>
              <img
              ...
              />
              <p className="w-64 flex text-center justify-center">Never miss an update. Subscribe to our newsletter.</p>
            </div>
          </CardContent>
          {/* <CardFooter>
