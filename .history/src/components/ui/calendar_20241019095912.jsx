  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-blue hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-primary text-primary-foreground hover:bg-primary/80",
        day_outside:
